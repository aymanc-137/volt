...
module.exports = {
    entry  : {
        ...
        product : [asset('js/product.js'), asset('js/products.js'),asset('js/category-ads.js'),asset('js/larage-category-image.js'),asset('js/car-search-tree.js'),asset('js/flash-offer.js'),asset('js/product-tabs.js')],
